...
<head>
    ...
    <title>Nosotros - Fernanda Campillo – Wedding & Event Planner</title>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <div class="barra">
                                                                        <div class="column-1_6">
                                                                            <img class="grow popb" src="images/nos1.png">
                                                                        </div>
                                                                        <div class="column-1_6">
                                                                            <img class="grow popb" src="images/nos2.png">
                                                                        </div>
                                                                        <div class="column-1_6">
                                                                            <img class="grow popb" src="images/nos3.png">
                                                                        </div>
                                                                        <div class="column-1_6">
                                                                            <img class="grow popb" src="images/nos4.png">
                                                                        </div>
                                                                        <div class="column-1_6">
                                                                            <img class="grow popb" src="images/nos5.png">
                                                                        </div>
                                                                    </div>
                                                                </div>
