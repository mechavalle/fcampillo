                                                                ...
                                                                <ul class="products">
                                                                    <li class="product has-post-thumbnail first">
                                                                        <div class="isotope_wrap">
                                                                            <div class="isotope_item isotope_item_masonry">
                                                                                <div class="post_featured">
                                                                                    <div class="post_thumb" data-image="images/post-1.jpg" data-title="The First Day of the Rest of Their Lives">
                                                                                        <a class="hover_icon hover_icon_link" href="blog-standart-post.html"><img class="post-image" src="images/post-1-370x284.jpg" style="width: 400px; height: 400px;"></a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="product has-post-thumbnail last" style="text-align: left; margin-left: -150px;">
                                                                        <h6 class="widget_title" style="color: #cab374; font-size: 20px; text-align: left;">Fernanda Campillo</h6>
                                                                        <div class="m_wrapper">
