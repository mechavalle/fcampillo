    ...
    <header class="top_panel_wrap top_panel_style_2 scheme_original">
        <div class="top_panel_bottom">
            <div class="content_wrap clearfix">
                <nav class="menu_main_nav_area menu_hover_fade" style="position: fixed; left: 0; top: 34px; width: 100%; background-color: #b2e4e3;">
                    <ul id="menu_main" class="menu_main_nav" style="font-size: larger;">
                        ...
                        <li style="height: auto; padding: 15px; width: 120px; display: inline-flex;"><a href="index.php"><img src="images/logotipo.png" style="display: flex; justify-content: center; position: absolute; width: 100%; left: 0; top: -25px;"></a></li>
