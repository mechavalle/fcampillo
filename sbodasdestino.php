...
<head>
    ...
    <title>Single Service – Fernanda Campillo</title>
...
<body class="single single-services body_filled sidebar_show sidebar_left sidebar_outer_hide">
	<!-- .body_wrap -->
            ...
            <div class="top_panel_title title_present">
                <div class="top_panel_title_inner title_present bg-breadcrumbs">
                    <div class="content_wrap">
                        <h1 class="page_title" style="font-family: delicious;">Bodas Destino</h1>
                        <div class="breadcrumbs">
                            <a class="breadcrumbs_item home" href="index.php">Home</a><span class="breadcrumbs_delimiter"></span><span class="breadcrumbs_item current">Bodas Destino</span>
                        </div>	
                    </div>
                </div>
            </div>	
                       ...
                       <!--.post_item .post_item_single -->
                        <article class="post_item post_item_single">
                            <section class="post_featured">
                                <div class="post_thumb" data-image="images/service-5.jpg" data-title="Single Service">
                                    <a class="hover_icon hover_icon_view" href="images/8417.jpg" title="Wedding Planning"><img class="post-image" alt="Single Service" src="images/8417.jpg"></a>
                                </div>
                            </section>
                            <!--.post_content-->
                                        ...
                                        <div class="columns_wrap">
                                            <div class="column_container column-1_1">
                                                <div class="column-inner">
                                                    <div class="m_wrapper">
                                                        <h4 class="sc_title sc_title_regular margin_top_medium margin_bottom_tiny sc_title-single-margin">Bodas Destino</h4>
                                                                        ...
                                                                        <ul class="products">
                                                                                ...
                                                                                <div class="post_item_wrap no-pb">
                                                                                    <div class="post_featured">
                                                                                        <div class="post_thumb">
                                                                                            <a class="hover_icon hover_icon_link" href="sbodasdestino.php"> <img src="images/product4-555x615.jpg"  alt="product4" title="product4"/> </a>
                                                                                        </div>
                                                                                    </div>
                                                                                   <div class="post_content">
                                                                                        <h3>Flower Decor</h3> <span class="price"><span class="amount"><span class="woocommerce-Price-currencySymbol">$</span>55.00</span>
                                                                            ...
                                                                            <li class="product has-post-thumbnail last">
                                                                                <div class="post_item_wrap no-pb">
                                                                                    <div class="post_featured">
                                                                                        <div class="post_thumb">
                                                                                            <a class="hover_icon hover_icon_link" href="sbodasdestino.php"> <img src="images/product5-555x615.jpg" alt="product5" title="product5" /> </a>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="post_content">
                                                                                        <h3>Wedding Bouquet</h3> <span class="price"><span class="amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>112.00</span>
                                                                                        </span> <a rel="nofollow" href="#" class="button add_to_cart_button">Add to cart</a>
                                                                                    </div>
                                                                                </div>
                                                                            </li>
                                            ...
                                            <div class="column_container column-1_1">
                                                <div class="column-inner">
                                                    <div class="m_wrapper">
                                                        <div class="m_text_column m_content_element ">
                                                            <div class="m_wrapper">
                                                                <p>Adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Sed ut perspiciatis, unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam eaque ipsa, quae ab illo inventore veritatis et quasi architecto.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="sidebar widget_area scheme_original">
                        <div class="sidebar_inner widget_area_inner">
                            <aside class="widget_number_1 widget widget_nav_menu">
                                <h5 class="widget_title">Services List</h5>
                                <div class="menu-services-menu-container">
                                    <ul id="menu-services-menu" class="menu">
                                        <li class="menu-item"><a href="swedding.php">Wedding Planning</a></li>
                                        <li class="menu-item"><a href="sevent.php">Event Planning</a></li>
                                        <li class="menu-item"><a href="sdecoracion.php">Decoración &#038; Ambientación</a></li>
                                        <li class="menu-item"><a href="smobiliario.php">Mobiliario e Iluminación</a></li>
                                        <li class="menu-item"><a href="sbanquetes.php">Banquetes &#038; Mesas de Dulces</a></li>
                                        <li class="menu-item"><a href="sbodasdestino.php">Bodas Destino</a></li>
                                    </ul>
                                </div>
                            </aside>
                        </div>
