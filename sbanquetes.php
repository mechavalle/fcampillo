            ...
            <div class="top_panel_title title_present">
                <div class="top_panel_title_inner title_present bg-breadcrumbs">
                    <div class="content_wrap">
                        <h1 class="page_title" style="font-family: delicious;">Banquetes y Mesas de Dulces</h1>
                        <div class="breadcrumbs">
                            <a class="breadcrumbs_item home" href="index.php">Home</a><span class="breadcrumbs_delimiter"></span><span class="breadcrumbs_item current">Banquetes y Mesas de Dulces</span>
                        </div>	
                    </div>
                </div>
            </div>	
                        ...
                        <article class="post_item post_item_single">
                            <section class="post_featured">
                                <div class="post_thumb" data-image="images/service-5.jpg" data-title="Single Service">
                                    <a class="hover_icon hover_icon_view" href="images/service-5.jpg" title="Wedding Planning"><img class="post-image" alt="Single Service" src="images/service-5-1170x659.jpg"></a>
                                </div>
                            </section>
                            <!--.post_content-->
                                        ...
                                        <div class="columns_wrap">
                                            <div class="column_container column-1_1">
                                                <div class="column-inner">
                                                    <div class="m_wrapper">
                                                        <h4 class="sc_title sc_title_regular margin_top_medium margin_bottom_tiny sc_title-single-margin">Banquetes y Mesas de Dulces</h4>
                                                                        ...
                                                                        <ul class="products">
                                                                                ...
                                                                                <div class="post_item_wrap no-pb">
                                                                                    <div class="post_featured">
                                                                                        <div class="post_thumb">
                                                                                            <a class="hover_icon hover_icon_link" href="sbanquetes.php"> <img src="images/product4-555x615.jpg"  alt="product4" title="product4"/> </a>
                                                                                        </div>
                                                                                    </div>
                                                                                   <div class="post_content">
                                                                            ...
                                                                            <li class="product has-post-thumbnail last">
                                                                                <div class="post_item_wrap no-pb">
                                                                                    <div class="post_featured">
                                                                                        <div class="post_thumb">
                                                                                            <a class="hover_icon hover_icon_link" href="sbanquetes.php"> <img src="images/product5-555x615.jpg" alt="product5" title="product5" /> </a>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="post_content">
                            ...
                            <aside class="widget_number_1 widget widget_nav_menu">
                                ...
                                <div class="menu-services-menu-container">
                                    <ul id="menu-services-menu" class="menu">
                                        <li class="menu-item"><a href="#">Bouquets &#038; Style</a></li>
                                        <li class="menu-item"><a href="#">Wedding Planning</a></li>
                                        <li class="menu-item"><a href="#">Catering &#038; Decoration</a></li>
                                        <li class="menu-item"><a href="#">Gift Ideas</a></li>
                                        <li class="menu-item"><a href="#">Ceremony Ideas</a></li>
                                        <li class="menu-item"><a href="#">Beach Weddings</a></li>
                                    </ul>
                                </div>
                            </aside>
                        </div>
