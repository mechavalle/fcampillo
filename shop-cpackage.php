    ...
    <div class="top_panel_title title_present">
        <div class="top_panel_title_inner title_present bg-breadcrumbs">
            <div class="content_wrap">
                <h1 class="page_title" style="font-family: delicious;">Coordination package</h1>
                    ...
                    <nav class="woocommerce-breadcrumb"><a href="index.html">Home</a>&nbsp;&#47;&nbsp;<a href="№">Flower Decor</a>&nbsp;&#47;&nbsp;Flower Decor</nav>
                        ...
                        <div class="product has-post-thumbnail first">
                            ...
                            <div class="summary entry-summary">
                                <h1 itemprop="name" class="product_title entry-title">Coordination package</h1>
                                <div itemprop="offers">
                                ...
                                <div itemprop="description">
                                    <p>Sabemos que cada evento es único y es por eso que siempre buscaremos conservar tu esencia y personalidad. Normalmente tenemos un año o quizás menos para organizar una boda o cualquier evento y si a esto le restamos las jornadas de trabajo ¿de cuánto tiempo dispones para que salga de la mejor manera? Nos encargaremos de planificar, organizar y coordinar ese gran día de principio a fin para entregarte un evento único y distintivo. Le daremos forma a ese gran día y pondremos en marcha todas tus ideas. </p>
                                </div>
